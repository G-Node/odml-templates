  ...
  <xsl:template match="odML">
    <html>
      ...
      <body>
        ...
        <div class="wrapper">
          <sec>
            <p><a href="https://templates.g-node.org/templates.xml">
              <img src="https://templates.g-node.org/_resources/odMLTitle.png"
                   title="Templates home" />
            </a></p>
            <h1>odML - Templates</h1>
            <p>This repository contains re-usable odML templates. A general introduction to
               odML and its usage can be found at the <a href="http://www.g-node.org/odml"
                                                         rel="nofollow">main odML page</a>.
            ...
            <p>If you would like to contribute and provide a new template to be shared with
               ...
               template on the corresponding <a href="https://github.com/G-Node/odml-templates"
                                                rel="nofollow">
