...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="odML">
    <html>
      <style type="text/css">
        <link href="http://templates.g-node.org/resources/odMLIcon.ico" rel="shortcut icon"
              csoptsettings="AQAAAD142mNgYNBomeIwObe4IIeBgYEvyTDuaAoPw3IFiwOcndS8HR1NjO0NDPTNdIzzEzOByni+A8EQNoAAPMPEQ4="
              livesrc="http://templates.g-node.org/resources/odMLIcon.png" />
      ...
      <body>
        <p><a href="index.html"><img src="http://templates.g-node.org/resources/odMLTitle.png" alt="" title="Home" height="128" width="707" border="0" /></a></p>
